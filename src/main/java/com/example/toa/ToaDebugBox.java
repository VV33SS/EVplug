...
public class ToaDebugBox extends Overlay
{
    ...
    private final net.runelite.client.plugins.toa.ToaPlugin plugin;
    private final ToaConfig config;
    private final PanelComponent panelComponent = new PanelComponent();

    @Inject
    ToaDebugBox(Client client, net.runelite.client.plugins.toa.ToaPlugin plugin, ToaConfig config, Zebak zebak)
    {
        this.client = client;
        this.plugin = plugin;
        this.config = config;
